...
#from model_persistence import get_persistence_dataset, train_test_split
...
def get_prophet_data(start_date, stop_date):
    data_comb = pd.read_csv('C:/Users/camib/Desktop/energy_weather_2015_2018.csv', parse_dates=True, index_col='time')
    #data_comb.head(3)
